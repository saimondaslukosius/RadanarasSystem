...
const defaultManualTemplateState = () => ({
  ...
  headerHtml: `
    <div style="padding:22px 24px; border:1px solid #dbeafe; border-radius:22px; background:linear-gradient(180deg,#fbfdff,#eef5ff); margin-bottom:10px;">
      <table style="width:100%; border-collapse:collapse;">
        <tr>
          <td style="width:58%; vertical-align:top; padding-right:16px;">
            <div data-logo-wrapper="true" style="text-align:left; margin-bottom:18px;">
              <img data-template-logo="true" src="{{company_logo}}" alt="Logo" style="width:220px; max-width:100%; height:auto; object-fit:contain; display:inline-block;" />
            </div>
            <div style="font-size:28px; line-height:1.1; font-weight:800; color:#0f172a; letter-spacing:-0.03em;">Transporto užsakymas</div>
            <div style="font-size:14px; color:#475569; margin-top:8px;">Vienkartinė krovinio pervežimo sutartis profesionaliam vežėjui</div>
          </td>
          <td style="width:42%; vertical-align:top;">
            <div style="padding:18px; background:#0f172a; color:#ffffff; border-radius:18px; box-shadow:inset 0 1px 0 rgba(255,255,255,0.08);">
              ...
              <div style="font-size:24px; font-weight:800; letter-spacing:-0.03em; margin-bottom:8px;">{{order_number}}</div>
  ...
  bodyHtml: `
    <div style="font-size:13px; color:#0f172a;">
      <div style="padding:16px 18px; background:#f8fafc; border:1px solid #e2e8f0; border-radius:16px; margin-bottom:18px;">
        <div style="font-size:11px; text-transform:uppercase; letter-spacing:0.12em; color:#64748b; margin-bottom:8px;">Sutarties šalys</div>
      ...
      <div style="display:grid; grid-template-columns:1.15fr 0.85fr; gap:14px; margin-bottom:14px;">
        <div style="padding:18px; border:1px solid #dbeafe; border-radius:18px; background:#ffffff; box-shadow:0 8px 24px rgba(15,23,42,0.04);">
          ...
          <table style="width:100%; border-collapse:separate; border-spacing:0 10px;">
            <tr>
              <td style="width:34%; font-weight:700; color:#1e293b; vertical-align:top;">Krovinys</td>
              <td style="color:#0f172a;">{{cargo}}</td>
            </tr>
            <tr>
              <td style="font-weight:700; color:#1e293b; vertical-align:top;">Maršrutas</td>
              <td style="color:#0f172a;">{{route}}</td>
            </tr>
            <tr>
              <td style="font-weight:700; color:#1e293b; vertical-align:top;">Pakrovimas</td>
              <td style="color:#0f172a;">{{loading_date}}</td>
            </tr>
            <tr>
              <td style="font-weight:700; color:#1e293b; vertical-align:top;">Iškrovimas</td>
              <td style="color:#0f172a;">{{unloading_date}}</td>
            </tr>
          </table>
        </div>
        <div style="padding:18px; border:1px solid #e2e8f0; border-radius:18px; background:linear-gradient(180deg,#ffffff,#f8fafc);">
          <div style="font-size:11px; text-transform:uppercase; letter-spacing:0.12em; color:#64748b; margin-bottom:12px;">Vežėjo finansai</div>
          <div style="display:grid; gap:10px;">
            <div style="padding:12px 14px; background:#f8fafc; border-radius:14px;">
              <div style="font-size:11px; color:#64748b; margin-bottom:4px;">Vežėjo kaina</div>
              <div style="font-size:20px; font-weight:800; color:#0f172a;">{{carrier_price}}</div>
            </div>
            <div style="padding:12px 14px; background:#ecfdf5; border-radius:14px;">
              <div style="font-size:11px; color:#64748b; margin-bottom:4px;">Mokėjimo terminas</div>
              <div style="font-size:16px; font-weight:700; color:#0f766e;">{{payment_term}}</div>
            </div>
          </div>
        </div>
      </div>

      <div style="padding:16px 18px; background:#0f172a; border-radius:18px; color:#ffffff; margin-bottom:20px;">
        <div style="font-size:11px; text-transform:uppercase; letter-spacing:0.12em; color:rgba(255,255,255,0.72); margin-bottom:8px;">Instrukcijos vežėjui</div>
        <div style="font-size:13px; line-height:1.7; color:rgba(255,255,255,0.92);">
          Atvykimą patvirtinti telefonu. CMR ir POD dokumentus pateikti laiku. Krovinys turi būti vežamas saugiai ir laikantis visų CMR reikalavimų.
        </div>
      </div>
      ...
      <div style="padding:22px 24px; border:1px solid #e2e8f0; border-radius:22px; background:#ffffff; margin-bottom:18px;">
        <div style="font-size:24px; font-weight:800; color:#0f172a; margin-bottom:8px;">Sąlygos ir atsakomybės</div>
        <div style="font-size:13px; color:#64748b; margin-bottom:18px;">Antras puslapis skirtas aiškioms sąlygoms, atsakomybėms ir darbų vykdymo taisyklėms.</div>
        <div style="display:grid; gap:12px;">
          <div style="padding:14px 16px; border-left:4px solid #2563eb; background:#f8fbff; border-radius:12px;">
            <strong>1.</strong> Vežėjas atsako už krovinio saugumą nuo pakrovimo iki iškrovimo ir užtikrina tinkamą transporto priemonės būklę.
          </div>
          <div style="padding:14px 16px; border-left:4px solid #0f766e; background:#f7fffb; border-radius:12px;">
            <strong>2.</strong> Užsakovas apmoka paslaugas pagal suderintą kainą ir nustatytą mokėjimo terminą.
          </div>
          <div style="padding:14px 16px; border-left:4px solid #9333ea; background:#fbf7ff; border-radius:12px;">
            <strong>3.</strong> Bet kokie nukrypimai nuo maršruto, grafiko ar krovinio informacijos turi būti suderinti iš anksto raštu.
          </div>
          <div style="padding:14px 16px; border-left:4px solid #dc2626; background:#fff7f7; border-radius:12px;">
            <strong>4.</strong> Vežėjas nedelsdamas informuoja užsakovą apie bet kokį incidentą, vėlavimą ar krovinio pažeidimą.
          </div>
        </div>
      </div>
      ...
      <div style="padding:22px 24px; border:1px solid #e2e8f0; border-radius:22px; background:linear-gradient(180deg,#ffffff,#fbfdff);">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px; margin-bottom:20px;">
          <div style="padding:18px; background:#f8fafc; border:1px solid #e2e8f0; border-radius:18px;">
            ...
            <div style="font-size:18px; font-weight:700; color:#0f172a; margin-bottom:8px;">{{client_name}}</div>
            <div style="font-size:13px; color:#475569; line-height:1.7;">Atsakingas už užsakymo pateikimą, grafiko koordinavimą ir apmokėjimą pagal sutartas sąlygas.</div>
          </div>
          <div style="padding:18px; background:#f8fafc; border:1px solid #e2e8f0; border-radius:18px;">
            <div style="font-size:11px; text-transform:uppercase; letter-spacing:0.12em; color:#64748b; margin-bottom:10px;">Vežėjas</div>
            <div style="font-size:18px; font-weight:700; color:#0f172a; margin-bottom:8px;">{{carrier_name}}</div>
            <div style="font-size:13px; color:#475569; line-height:1.7;">Atsakingas už krovinio priėmimą, saugų transportavimą ir pristatymą nurodytu laiku.</div>
          </div>
        </div>
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
          <div style="padding:18px; border:1px dashed #94a3b8; border-radius:18px; min-height:160px;">
            <div style="font-size:11px; text-transform:uppercase; letter-spacing:0.12em; color:#64748b; margin-bottom:14px;">Parašas</div>
          ...
          <div style="padding:18px; border:1px dashed #94a3b8; border-radius:18px; min-height:160px; display:flex; flex-direction:column; justify-content:space-between; align-items:flex-end;">
            <div style="font-size:11px; text-transform:uppercase; letter-spacing:0.12em; color:#64748b;">Antspaudas</div>
            <img src="{{company_stamp_signature}}" alt="Stamp" style="max-height:92px; max-width:180px; object-fit:contain;" />
            <div style="font-size:12px; color:#475569;">Įmonės antspaudas / parašas</div>
          </div>
        </div>
      </div>
    </div>
  ...
  footerHtml: `
    <div style="display:flex; justify-content:space-between; align-items:center; gap:16px; padding-top:12px; border-top:1px solid #e2e8f0; font-size:11px; color:#64748b;">
      <div>{{client_name}} • Transporto dokumentas</div>
...
export function TemplateManager({ settings, saveSettings }) {
  ...
  const onEditableInput = (key, ref) => {
    syncSectionState(key, ref.current?.innerHTML || "");
  };
  ...
  useEffect(() => {
    ...
    const bodyWidth = pageSize.width - mmToPx(manualState.layout.marginLeft + manualState.layout.marginRight);
    const bodyHeight = pageSize.height
      - mmToPx(manualState.layout.marginTop + manualState.layout.marginBottom + manualState.layout.headerSpacing + manualState.layout.footerSpacing)
      - (renderedHeader ? 140 : 0)
      - (renderedFooter ? 110 : 0);

    const sourceDoc = new DOMParser().parseFromString(`<div>${renderedBody || "<p></p>"}</div>`, "text/html");
    ...
    sourceNodes.forEach((node) => {
      ...
      if (page.scrollHeight > bodyHeight && page.childNodes.length > 1) {
    ...
    measureRoot.innerHTML = "";
  }, [manualState, pageSize.width, pageSize.height, renderedBody, renderedFooter, renderedHeader]);
    ...
    <div>
      ...
      {mode === "manual" && (
        <>
            ...
            <div style={{ display: "grid", gap: "18px" }}>
              ...
              <div style={{ padding: "18px", border: "1px solid #e2e8f0", borderRadius: "12px", background: "#fff" }}>
                ...
                <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", marginBottom: "12px" }}>
                  <select title="Pasirinkti teksto stilių" style={{ ...inputBase, width: "auto" }} value="p" onChange={(e) => exec("formatBlock", e.target.value)}>
                  ...
                  <select title="Keisti teksto dydį" style={{ ...inputBase, width: "auto" }} value={fontScale} onChange={(e) => { setFontScale(e.target.value); exec("fontSize", e.target.value); }}>
                  ...
                  <input title="Keisti teksto spalvą" type="color" value={textColor} onChange={(e) => { setTextColor(e.target.value); exec("foreColor", e.target.value); }} style={{ width: "46px", height: "42px", border: "1px solid #cbd5e1", borderRadius: "8px", padding: "4px", background: "#fff" }} />
                  {[
                    ["B", "Paryškinti tekstą", () => exec("bold")],
                    ["I", "Pasviras tekstas", () => exec("italic")],
                    ["U", "Pabraukti tekstą", () => exec("underline")],
                    ["•", "Ženklintas sąrašas", () => exec("insertUnorderedList")],
                    ["1.", "Numeruotas sąrašas", () => exec("insertOrderedList")],
                    ["←", "Lygiuoti kairėje", () => exec("justifyLeft")],
                    ["↔", "Lygiuoti centre", () => exec("justifyCenter")],
                    ["→", "Lygiuoti dešinėje", () => exec("justifyRight")]
                  ].map(([buttonLabel, tooltip, handler]) => (
                    <button title={tooltip} key={buttonLabel} type="button" style={{ ...btnSecondary, padding: "8px 12px", fontSize: "12px", minWidth: "42px" }} onMouseDown={(e) => { e.preventDefault(); handler(); }}>
                      {buttonLabel}
                    </button>
                  ))}
                </div>
                ...
                <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
                  {templateFieldOptions.map((field) => (
                    <button title={`Įterpti lauką: ${field.label}`} key={field.key} type="button" style={{ background: "#eff6ff", color: "#1d4ed8", border: "1px solid #bfdbfe", borderRadius: "999px", padding: "6px 10px", fontSize: "12px", cursor: "pointer" }} onMouseDown={(e) => { e.preventDefault(); insertField(field.key); }}>
                      {field.label}
                    </button>
                  ))}
                </div>
              ...
              <div style={{ padding: "18px", border: "1px solid #e2e8f0", borderRadius: "12px", background: "#fff" }}>
                ...
                <div style={{ ...formGrid, gridTemplateColumns: "1fr 1fr", marginBottom: "12px" }}>
                  ...
                  <div style={formGroup}>
                    <label style={label}>Logo dydis (px)</label>
                    <input style={inputBase} type="number" value={manualState.assets.logoWidth} onChange={(e) => updateLogoSetting("logoWidth", Math.max(80, Number(e.target.value) || 220))} />
                  </div>
                </div>
                <div style={{ ...formGrid, gridTemplateColumns: "1fr 1fr", marginBottom: 0 }}>
                  ...
                  <div style={formGroup}>
                    ...
                    <div style={{ padding: "12px", background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: "12px", minHeight: "96px", display: "flex", justifyContent: manualState.assets.logoAlign === "left" ? "flex-start" : manualState.assets.logoAlign === "center" ? "center" : "flex-end", alignItems: "center" }}>
                      <img src={manualState.assets.logoSrc || previewFields.company_logo} alt="Logo preview" style={{ width: `${manualState.assets.logoWidth}px`, maxWidth: "100%", height: "auto", objectFit: "contain" }} />
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  {[
                    ...
                    <div key={key}>
                      ...
                      <div
                        ...
                        style={{
                          minHeight: key === "body" ? "300px" : "140px",
              ...
              {templates.length > 0 && (
                <div style={{ padding: "18px", border: "1px solid #e2e8f0", borderRadius: "12px", background: "#fff" }}>
                  <div style={{ fontSize: "14px", fontWeight: 700, color: "#1e3a8a", marginBottom: "12px" }}>Išsaugoti šablonai</div>
                  <div style={{ display: "grid", gap: "10px" }}>
                    {templates.map((template) => (
                      <div key={template.id} style={{ border: "1px solid #e2e8f0", borderRadius: "10px", padding: "14px", background: "#f8fafc" }}>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", gap: "12px" }}>
                          <div>
                            <div style={{ fontWeight: 700, color: "#0f172a", marginBottom: "4px" }}>{template.name}</div>
                            <div style={{ fontSize: "12px", color: "#64748b" }}>
                          ...
                          <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
                            <button type="button" style={btnSecondary} onClick={() => loadTemplate(template)}>Redaguoti</button>
                            <button
                              type="button"
                              style={{ ...btnSecondary, background: "#dc2626" }}
                              onClick={() => {
                ...
                <div ref={previewViewportRef} style={{ maxHeight: "calc(100vh - 180px)", overflow: "auto", paddingRight: "4px", background: "#e2e8f0", borderRadius: "10px", padding: "16px" }}>
                      ...
                      <div style={{ background: "#fff", border: "1px solid #cbd5e1", boxShadow: "0 18px 36px rgba(15,23,42,0.14)", width: `${pageSize.width}px`, minHeight: `${pageSize.height}px`, zoom: previewScale }}>
                        <div style={{ padding: `${manualState.layout.marginTop}mm ${manualState.layout.marginRight}mm ${manualState.layout.marginBottom}mm ${manualState.layout.marginLeft}mm`, boxSizing: "border-box", minHeight: `${pageSize.height}px`, fontFamily: "Arial, Helvetica, sans-serif" }}>
                          <div
                            ...
                            dangerouslySetInnerHTML={{ __html: manualState.headerHtml }}
                          />
                          <div
                            ref={previewBodyRef}
                            contentEditable
                            ...
                            dangerouslySetInnerHTML={{ __html: manualState.bodyHtml }}
                          />
                          <div
                            ...
                            dangerouslySetInnerHTML={{ __html: manualState.footerHtml }}
                          />
                        </div>
                      </div>
                    </div>
                  ...
                  {previewMode === "pages" && previewPages.map((pageHtml, index) => (
                    <div key={index} style={{ marginBottom: `${manualState.layout.pageGap}px` }}>
                      <div style={{ fontSize: "12px", color: "#475569", marginBottom: "8px", fontWeight: 600 }}>Puslapis {index + 1}</div>
                      <div style={{ width: `${pageSize.width * previewScale}px`, minHeight: `${pageSize.height * previewScale}px`, position: "relative", background: "#fff", border: "1px solid #cbd5e1", boxShadow: "0 10px 30px rgba(15, 23, 42, 0.12)", overflow: "hidden" }}>
                        <div style={{ width: `${pageSize.width}px`, minHeight: `${pageSize.height}px`, transform: `scale(${previewScale})`, transformOrigin: "top left", background: "#fff" }}>
                          <div style={{ padding: `${manualState.layout.marginTop}mm ${manualState.layout.marginRight}mm ${manualState.layout.marginBottom}mm ${manualState.layout.marginLeft}mm`, boxSizing: "border-box", minHeight: `${pageSize.height}px`, fontFamily: "Arial, Helvetica, sans-serif", color: "#0f172a" }}>
                            <div dangerouslySetInnerHTML={{ __html: renderedHeader }} />
                            <div style={{ marginTop: `${manualState.layout.headerSpacing}mm` }} dangerouslySetInnerHTML={{ __html: pageHtml }} />
                            <div style={{ marginTop: `${manualState.layout.footerSpacing}mm` }} dangerouslySetInnerHTML={{ __html: renderedFooter }} />
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div ref={measureRef} style={{ position: "absolute", left: "-99999px", top: 0, visibility: "hidden" }} />
        </>
      )}
