  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px", paddingBottom: "16px", borderBottom: "2px solid #e2e8f0" }}>
        <div>
          <h2 style={{ margin: 0, fontSize: "22px", color: "#1e3a8a", fontWeight: 800 }}>
            🌐 TransFlow Admin Console
          </h2>
          <div style={{ fontSize: "13px", color: "#64748b", marginTop: "4px" }}>
            Platform administration — companies, subscriptions, payments
          </div>
        </div>
        <div style={{ background: "linear-gradient(135deg, #1e3a8a, #3b82f6)", color: "white", padding: "6px 14px", borderRadius: "999px", fontSize: "11px", fontWeight: 700, letterSpacing: "0.5px" }}>
          PLATFORM ADMIN
        </div>
      </div>
